...
import { Users, DollarSign, Brain, Play } from "lucide-react"
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-[800px] space-y-6 text-center">
              ...
              <div className="space-y-4 text-left">
                <p className="text-lg">
                  Every day, thousands of veterans struggle silently with the invisible wounds of service. After
                  sacrificing for our freedom, many return home to face battles with PTSD, depression, homelessness, and
                  unemployment. Warriors Aid was founded on the principle that{" "}
                  <strong>no veteran should fight these battles alone</strong>.
                </p>
                <p className="text-lg">
                  Our organization bridges critical gaps in veteran support systems through three core initiatives:
                </p>
                ...
                <p className="text-lg">
                  ...
                  service. Your support directly impacts veterans in your community, providing them with the resources,
                ...
                <p className="text-lg font-semibold">
                  The time to act is now. Our veterans stood for us—it's time we stand for them.
                </p>
              </div>
            ...
            <div className="mx-auto max-w-[800px] space-y-6 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-10">
                <Card className="border-red-200 bg-white">
                  ...
                  <CardContent className="text-center">
                    <p className="text-4xl font-bold text-red-600">22</p>
                    <p className="text-muted-foreground">Veterans lost to suicide daily</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-blue-200 bg-white">
                  ...
                  <CardContent className="text-center">
                    <p className="text-4xl font-bold text-blue-600">40,000+</p>
                ...
                <Card className="border-green-200 bg-white">
                  ...
                  <CardContent className="text-center">
                    <p className="text-4xl font-bold text-green-600">5.3%</p>
                    <p className="text-muted-foreground">Higher than civilian rate</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-left">
                  This infographic employs stark statistics and simple iconography to create an immediate emotional
                  impact. The use of red for the suicide statistics deliberately evokes urgency and alarm, while the
                  clean, minimalist design ensures the gravity of these numbers isn't lost in visual clutter. By
                  presenting these statistics in isolation, we force the viewer to confront the reality of veteran
                  struggles without distraction. The progression from mental health to homelessness to unemployment
                  creates a narrative of cause and effect that educated viewers will immediately comprehend, making a
                  logical appeal (logos) while simultaneously evoking emotional response (pathos). This visual rhetoric
                  serves to transform abstract statistics into human stories, compelling action through both
                  intellectual and emotional channels.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mx-auto max-w-[800px] space-y-6 text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-left">
                  ...
                  emotional connection with viewers (pathos). The video format allows for a complete narrative
                  arc—showing the challenges, the intervention, and the transformation—which builds a compelling logical
                  case for our effectiveness (logos). The cinematic quality and professional production values signal
                  respect for both the subject matter and the audience, acknowledging the sophistication of educated
                  viewers while still making the content accessible and emotionally resonant. The title "My Journey
                  Home" frames the veteran experience as an ongoing process rather than a fixed state, inviting viewers
                  to see themselves as potential participants in that journey rather than mere observers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-[800px] space-y-6 text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-left">
                  Our slogan "Honoring Their Sacrifice, Rebuilding Their Future" employs deliberate rhetorical
                  techniques to encapsulate our mission while resonating with multiple audiences. The parallel structure
                  creates a balanced rhythm that makes the phrase memorable and impactful. The first half, "Honoring
                  Their Sacrifice," acknowledges the debt society owes to veterans, appealing to patriotic values and
                  establishing common ground with our audience. The second half, "Rebuilding Their Future," shifts from
                  passive recognition to active intervention, signaling our organization's commitment to tangible action
